...
default_kernels_dict = {
    ...
    (-7): kernelInstance( 256,     128,  128,    64,  16,  16,  16,   16,    8,    2,    [4, 64, 1],        [4, 64, 1],              2,           1,                 [1, 32, 1, 8],       [8, 8, 1],         "Intrawave",         3),
    (-8): kernelInstance(  64,      16,  256,    64,  16,  16,  16,   16,    1,   16,    [4, 16, 1],        [4, 16, 1],              1,           8,                 [1, 8, 1, 8],        [8, 8, 1],         "Intrawave",         1),
    (-9): kernelInstance( 128,      32,  256,    64,  16,  16,  16,   16,    2,    8,    [4, 32, 1],        [4, 32, 1],              1,           4,                 [1, 8, 1, 16],       [8, 8, 1],         "Intrawave",         1),
}
# fmt: on
